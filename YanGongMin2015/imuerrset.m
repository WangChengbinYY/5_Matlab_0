function imuerr = imuerrset(eb, db, web, wdb, sqrtR0G, TauG, sqrtR0A, TauA, dKGii, dKAii, dKGij, dKAij)
...
%     dKAii - acc scale factor error (arcsec)
%     dKGij - gyro installation error (ppm)
...
% 11/09/2013, 06/03/2014, 15/02/2015, 22/08/2015
global glv
    ...
    imuerr = struct('eb',o31, 'db',o31, 'web',o31, 'wdb',o31,...
        'sqg',o31, 'taug',inf(3,1), 'sqa',o31, 'taua',inf(3,1), 'dKg',o33, 'dKa',o33, 'dKga',zeros(15,1)); 
