function [Xkk_1, Phikk_1] = Jacob5(Xk_1, wnie, fn, ts)  %***²Î¿¼YGM readme.doc p19 Ê½10.4-6
% Copyright(c) 2009-2014, by Gongmin Yan, All rights reserved.
% Northwestern Polytechnical University, Xi An, P.R.China
% 05/09/2013
%x=[phie,phin,phiu,deltave deltavn]
%***
    ax = Xk_1(1); ay = Xk_1(2); az = Xk_1(3); dvx = Xk_1(4); dvy = Xk_1(5);  %phi,v
...
%     jF(3,1) = caz*wN; jF(3,2) = -saz*wN; jF(3,3) = -ax*saz*wN-ay*caz*wN;
    jF(4,1) = -saz*fnz; jF(4,2) = -caz*fnz; jF(4,3) = saz*fnx+caz*fny-(-ay*saz+ax*caz)*fnz;  %**Ê½10.4-8
