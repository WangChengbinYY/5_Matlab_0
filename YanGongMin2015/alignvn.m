...
function kf = avnkfinit(nts, pos, phi0, imuerr, wvn)  %定义kalman滤波函数
...
global glv
	...
	subplot(426); plot(t, sqrt(xkpk(:,19:21))/glv.dph); xygo('eb'); %陀螺零偏估计值标准差
 	subplot(428); plot(t, sqrt(xkpk(:,22:24))/glv.ug); xygo('db');  %估计值标注差 
